...
VALUES
  ...
  (7, 1, NULL, 'Database', TRUE, 'fa-database', 3, 'com.angkorteam.mbaas.server.page.collection.CollectionBrowsePage'),
  (8, NULL, 1, 'File', TRUE, 'fa-floppy-o', 6, 'com.angkorteam.mbaas.server.page.file.FileBrowsePage'),
  (9, NULL, 2, 'User', TRUE, 'fa-users', 2, 'com.angkorteam.mbaas.server.groovy.UserBrowsePage'),
  (10, 1, NULL, 'Service', TRUE, 'fa-code', 4, 'com.angkorteam.mbaas.server.page.rest.RestBrowsePage'),
