...
VALUES
  (1, NULL, 1, 'Section', TRUE, 'fa-list-ul', 1, 'com.angkorteam.mbaas.server.page.section.SectionBrowsePage'),
  (2, NULL, 1, 'Menu', TRUE, 'fa-list-ul', 2, 'com.angkorteam.mbaas.server.page.menu.MenuBrowsePage'),
  (3, NULL, 1, 'Menu Item', TRUE, 'fa-list-ul', 3, 'com.angkorteam.mbaas.server.page.menuitem.MenuItemBrowsePage'),
