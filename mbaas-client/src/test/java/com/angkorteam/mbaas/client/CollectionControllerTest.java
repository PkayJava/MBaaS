...
//            request.getActions().add(CollectionPermissionEnum.Modify.getLiteral());
//            request.getActions().add(CollectionPermissionEnum.Read.getLiteral());
//            CollectionPermissionUsernameResponse response = client.collectionPermissionGrantUsername(request);
//            Assert.assertEquals(response.getHttpCode().intValue(), 200);
//            Assert.assertEquals(response.getData().getPermission().intValue(), CollectionPermissionEnum.Create.getLiteral() | CollectionPermissionEnum.Delete.getLiteral() | CollectionPermissionEnum.Modify.getLiteral() | CollectionPermissionEnum.Read.getLiteral());
//        }
//
//        {
//            CollectionDeleteRequest request = new CollectionDeleteRequest();
...
//            Assert.assertEquals(response.getData().getPermission().intValue(), CollectionPermissionEnum.Delete.getLiteral() | CollectionPermissionEnum.Modify.getLiteral() | CollectionPermissionEnum.Read.getLiteral());
//        }
//
//        {
//            CollectionDeleteRequest request = new CollectionDeleteRequest();
...
//            Assert.assertEquals(response.getHttpCode().intValue(), 200);
//            Assert.assertEquals(response.getData().getPermission().intValue(), CollectionPermissionEnum.Create.getLiteral() | CollectionPermissionEnum.Delete.getLiteral());
//        }
//
//        {
//            CollectionDeleteRequest request = new CollectionDeleteRequest();
