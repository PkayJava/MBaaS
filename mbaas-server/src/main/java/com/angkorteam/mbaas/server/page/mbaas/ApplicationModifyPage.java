...
public class ApplicationModifyPage extends MBaaSPage {
    ...
    protected void onInitialize() {
        ...
        this.code = applicationRecord.getCode();
    ...
    protected void onBeforeRender() {
        ...
        ApplicationTable applicationTable = Tables.APPLICATION.as("applicationTable");
        ApplicationRecord applicationRecord = context.select(applicationTable.fields()).from(applicationTable).where(applicationTable.APPLICATION_ID.eq(this.applicationId)).fetchOneInto(applicationTable);
        if (getSession().isMBaaSAdministrator() && !applicationRecord.getMbaasUserId().equals(getSession().getMbaasUserId())) {
