...
// */
//public class MBaaSUserMobileNumberValidator extends JooqValidator<String> {
//
//    private String mbaasUserId;
//
//    public MBaaSUserMobileNumberValidator() {
//    }
//
//    public MBaaSUserMobileNumberValidator(String mbaasUserId) {
...
//            } else {
//                count = context.selectCount().from(userTable).where(userTable.MOBILE_NUMBER.eq(mobileNumber)).and(userTable.MBAAS_USER_ID.ne(this.mbaasUserId)).fetchOneInto(int.class);
//            }
//            if (count > 0) {
