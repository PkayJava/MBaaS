...
public interface IHiddenFieldFactory extends Serializable {
    ...
    <T> NashornHiddenField<T> createHiddenField(String id, Class<T> type);

    <T> NashornHiddenField<T> createHiddenField(MarkupContainer container, String id, Class<T> type);
