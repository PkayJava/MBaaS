 ...
 */
public class QueryParameterSubTypeValidator extends AbstractFormValidator {
    ...
    public QueryParameterSubTypeValidator(DropDownChoice<String> fieldType, DropDownChoice<String> fieldSubType) {
    ...
    public void validate(Form<?> form) {
        if (fieldType.getConvertedInput() != null && !"".equals(fieldType.getConvertedInput())) {
            if (QueryInputParamTypeEnum.List.getLiteral().equals(fieldType.getConvertedInput())) {
