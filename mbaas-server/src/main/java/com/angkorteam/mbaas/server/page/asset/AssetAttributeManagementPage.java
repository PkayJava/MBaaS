...
@Mount("/asset/attribute/management")
public class AssetAttributeManagementPage extends MasterPage implements ActionFilteredJooqColumn.Event {

    private String collectionId;

    @Override
    public String getPageHeader() {
        return "Asset Attribute Management";
    }
    ...
    protected void onInitialize() {
        ...
        BookmarkablePageLink<Void> refreshLink = new BookmarkablePageLink<>("refreshLink", AssetAttributeManagementPage.class, getPageParameters());
        add(refreshLink);
    }
    ...
    public void onClickEventLink(String link, Map<String, Object> object) {
        if ("Delete".equals(link)) {
            ...
            AssetAttributeFunction.deleteAttribute(context, jdbcTemplate, requestBody);
        }
    }
