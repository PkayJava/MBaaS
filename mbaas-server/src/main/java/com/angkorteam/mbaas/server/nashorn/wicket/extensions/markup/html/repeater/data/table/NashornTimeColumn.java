...
// */
//public class NashornTimeColumn extends TextFilteredPropertyColumn<Map<String, Object>, Map<String, String>, String> {
//
//    public NashornTimeColumn(IModel<String> headerModel, String columnName) {
...
//        return date == null ? null : new Model<>(DateFormatUtils.format(date, "HH:mm:ss"));
//    }
//
//}
