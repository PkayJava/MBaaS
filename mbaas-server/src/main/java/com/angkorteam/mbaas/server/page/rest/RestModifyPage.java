...
@Mount("/rest/modify")
public class RestModifyPage extends MasterPage {
    ...
    protected void onInitialize() {
        ...
        Map<String, Object> restRecord = jdbcTemplate.queryForMap("SELECT * FROM " + Jdbc.REST + " WHERE " + Jdbc.Rest.REST_ID + " = ?", this.restId);
        ...
        this.requestPath = (String) restRecord.get(Jdbc.Rest.PATH);
        ...
        this.description = (String) restRecord.get(Jdbc.Rest.DESCRIPTION);
        ...
        this.name = (String) restRecord.get(Jdbc.Rest.NAME);
        ...
        this.responseContentType = (String) restRecord.get(Jdbc.Rest.RESPONSE_CONTENT_TYPE);
        ...
        this.responseBodySubType = (String) restRecord.get(Jdbc.Rest.RESPONSE_BODY_SUB_TYPE);
        ...
        List<String> responseHeaderRequiredIds = jdbcTemplate.queryForList("SELECT " + Jdbc.RestResponseHeader.HTTP_HEADER_ID + " FROM " + Jdbc.REST_RESPONSE_HEADER + " WHERE " + Jdbc.RestResponseHeader.REST_ID + " = ? AND " + Jdbc.RestRequestHeader.REQUIRED + " = true", String.class, restRecord.get(Jdbc.Rest.REST_ID));
        ...
        List<String> responseHeaderOptionalIds = jdbcTemplate.queryForList("SELECT " + Jdbc.RestResponseHeader.HTTP_HEADER_ID + " FROM " + Jdbc.REST_RESPONSE_HEADER + " WHERE " + Jdbc.RestResponseHeader.REST_ID + " = ? AND " + Jdbc.RestRequestHeader.REQUIRED + " = false", String.class, restRecord.get(Jdbc.Rest.REST_ID));
        ...
        this.form.add(new RestNameValidator(getSession().getApplicationCode(), this.requestPathField, this.methodField, this.restId));
        ...
        this.method = (String) restRecord.get(Jdbc.Rest.METHOD);
        methodFieldAjaxUpdate(null);
        this.requestContentType = (String) restRecord.get(Jdbc.Rest.REQUEST_CONTENT_TYPE);
        requestContentTypeFieldAjaxUpdate(null);
        this.requestBodyType = (String) restRecord.get(Jdbc.Rest.REQUEST_BODY_TYPE);
        requestBodyTypeFieldAjaxUpdate(null);
        this.requestBodySubType = (String) restRecord.get(Jdbc.Rest.REQUEST_BODY_SUB_TYPE);
        requestBodySubTypeFieldAjaxUpdate(null);

        this.responseContentType = (String) restRecord.get(Jdbc.Rest.RESPONSE_CONTENT_TYPE);
        responseContentTypeFieldAjaxUpdate(null);
        this.responseBodyType = (String) restRecord.get(Jdbc.Rest.RESPONSE_BODY_TYPE);
        responseBodyTypeFieldAjaxUpdate(null);
        this.responseBodySubType = (String) restRecord.get(Jdbc.Rest.RESPONSE_BODY_SUB_TYPE);
        responseBodySubTypeFieldAjaxUpdate(null);
    }
    ...
    private void saveButtonOnSubmit(Button button) {
        ...
        jdbcUpdate.withTableName(Jdbc.REST);
        Map<String, Object> wheres = new HashMap<>();
        wheres.put(Jdbc.Rest.REST_ID, this.restId);
        ...
        if (this.requestBodyEnum != null) {
            ...
            fields.put(Jdbc.Rest.REQUEST_BODY_ENUM_ID, null);
        }
        if (this.requestBodyMapJson != null) {
            ...
            fields.put(Jdbc.Rest.REQUEST_BODY_MAP_JSON_ID, null);
        }
        ...
        if (this.responseBodyEnum != null) {
            ...
            fields.put(Jdbc.Rest.RESPONSE_BODY_ENUM_ID, null);
        }
        if (this.responseBodyMapJson != null) {
            ...
            fields.put(Jdbc.Rest.RESPONSE_BODY_MAP_JSON_ID, null);
        }
