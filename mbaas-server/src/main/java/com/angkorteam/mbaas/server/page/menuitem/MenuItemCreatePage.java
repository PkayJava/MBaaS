 ...
 */
public class MenuItemCreatePage extends MBaaSPage {
    ...
    public String getPageUUID() {
        return MenuItemCreatePage.class.getName();
    }
    ...
    private void saveButtonOnSubmit(Button button) {
        ...
        MenuItemRecord menuItemRecord = context.newRecord(menuItemTable);
        menuItemRecord.setMenuItemId(uuid);
        menuItemRecord.setTitle(this.title);
        menuItemRecord.setOrder(this.order);
        menuItemRecord.setIcon(this.icon);
        menuItemRecord.setSystem(false);
