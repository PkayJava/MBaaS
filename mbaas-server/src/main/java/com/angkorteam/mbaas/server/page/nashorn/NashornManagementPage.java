package com.angkorteam.mbaas.server.page.nashorn;
...
@Mount("/nashorn/management")
public class NashornManagementPage extends MasterPage implements ActionFilteredJooqColumn.Event {
