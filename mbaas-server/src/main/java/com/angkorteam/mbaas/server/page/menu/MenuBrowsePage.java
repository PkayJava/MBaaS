 ...
 */
public class MenuBrowsePage extends MBaaSPage implements TableEvent {
    ...
    protected void doInitialize(Border layout) {
        ...
        columns.add(new TextFilteredColumn(String.class, Model.of("parent"), "parent", this, provider));
