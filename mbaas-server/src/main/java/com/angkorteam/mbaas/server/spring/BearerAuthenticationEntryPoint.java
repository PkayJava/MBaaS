...
import com.angkorteam.mbaas.server.page.BearerPage;
...
public class BearerAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response,
        ...
        address.append(HttpFunction.getHttpAddress(request)).append("/web" + BearerPage.class.getAnnotation(Mount.class).value());
