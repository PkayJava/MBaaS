package com.angkorteam.mbaas.server.page.setting;
...
@Mount("/setting/management")
public class SettingManagementPage extends MasterPage implements ActionFilteredJooqColumn.Event {
